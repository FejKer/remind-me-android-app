...
public interface EventDao {
    ...
    @Query("SELECT * FROM events WHERE date <=:nowPlus72Hours AND date >=:today AND deleted IS FALSE AND isHiddenFromScreenSaver IS FALSE AND isRecurring IS FALSE ORDER BY date ASC, time ASC")
